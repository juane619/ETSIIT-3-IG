...
void _file_ply::get_token(istringstream &Line_stream1, string &Token1) const{
...
bool _file_ply::get_new_line(ifstream &File, istringstream &Line_stream) const{
    string Line;
            ...
            if (Token == "ascii") {
                ...
                if (Token == "vertex") {
                    ...
                    if (Token == "face") {
                        ...
                        for (unsigned i = 0; i < vertices_p.size(); i++) {
                            get_new_line(File, Line_stream);
                            //
                        ...
                        for (unsigned i = 0; i < caras_p.size(); i++) {
                            get_new_line(File, Line_stream);
