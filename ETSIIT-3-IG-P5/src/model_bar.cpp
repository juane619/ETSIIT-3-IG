...
void Bar::generarBarTras(float mult) {
    ...
    for (unsigned i = 0; i < n_caras; i++) {
        Punto3D punto_x(
                vertices[caras[i].getX()].getX() + normales_vertices[i].getX() * mult,
                vertices[caras[i].getX()].getY() + normales_vertices[i].getY() * mult,
                vertices[caras[i].getX()].getZ() + normales_vertices[i].getZ() * mult);
        Punto3D punto_y(
                vertices[caras[i].getY()].getX() + normales_vertices[i].getX() * mult,
                vertices[caras[i].getY()].getY() + normales_vertices[i].getY() * mult,
                vertices[caras[i].getY()].getZ() + normales_vertices[i].getZ() * mult);
        Punto3D punto_z(
                vertices[caras[i].getZ()].getX() + normales_vertices[i].getX() * mult,
                vertices[caras[i].getZ()].getY() + normales_vertices[i].getY() * mult,
                vertices[caras[i].getZ()].getZ() + normales_vertices[i].getZ() * mult);
